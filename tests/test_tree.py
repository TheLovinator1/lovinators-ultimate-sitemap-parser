...
class TestSitemapTree(TestCase):
    ...
    TEST_DATE_STR_ISO8601: str = TEST_DATE_DATETIME.isoformat()
    """Test string date formatted as ISO 8601 (for XML and Atom 0.3 / 1.0 sitemaps)."""

    TEST_DATE_STR_RFC2822: str = format_datetime(TEST_DATE_DATETIME)
    ...
    def test_sitemap_tree_for_homepage(self: TestSitemapTree) -> None:
        """Test sitemap_tree_for_homepage()."""
        with requests_mock.Mocker() as m:
                            ...
                            PagesXMLSitemap(
                                ...
                                pages=[
                                    ...
                                    SitemapPage(
                                        ...
                                        # Invalid input -- should be reset to 0.5 (the default as per the spec) # noqa: E501
            ...
            actual_sitemap_tree: AbstractSitemap = sitemap_tree_for_homepage(
                homepage_url=self.TEST_BASE_URL,
            )

            expected_lines: list[str] = str(expected_sitemap_tree).split()
            actual_lines: list[str] = str(actual_sitemap_tree).split()
            diff: Iterator[str] = difflib.ndiff(expected_lines, actual_lines)
            diff_str: str = "\n".join(diff)
    ...
    def test_sitemap_tree_for_homepage_gzip(self: TestSitemapTree) -> None:
        ...
        with requests_mock.Mocker() as m:
            ...
            assert isinstance(
                actual_sitemap_tree.sub_sitemaps[0],
                IndexRobotsTxtSitemap,
            )
    ...
    def test_sitemap_tree_for_homepage_plain_text(self: TestSitemapTree) -> None:
    ...
    def test_sitemap_tree_for_homepage_rss_atom(self: TestSitemapTree) -> None:
    ...
    def test_sitemap_tree_for_homepage_no_sitemap(self: TestSitemapTree) -> None:
    ...
    def test_sitemap_tree_for_homepage_robots_txt_no_content_type(
        self: TestSitemapTree,
    ) -> None:
    ...
    def test_sitemap_tree_for_homepage_no_robots_txt(self: TestSitemapTree) -> None:
    ...
    def test_sitemap_tree_for_homepage_robots_txt_weird_spacing(
        self: TestSitemapTree,
    ) -> None:
    ...
    def test_sitemap_tree_for_homepage_utf8_bom(self: TestSitemapTree) -> None:
        ...
        sitemap_xml_body_encoded: bytes = sitemap_xml_body.encode("utf-8-sig")
